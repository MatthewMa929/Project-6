...
enum AIState    { WALKING, IDLE, ATTACKING, PATROL, GUARDING };
...
public:
    ...
    void ai_walker();
    void ai_jumper();
    void ai_patrol(Entity* player, glm::vec3 pt1, glm::vec3 pt2);
    ...
    void const set_patrol_pts(glm::vec3(new_pt1), glm::vec3(new_pt2)) { pt1 = new_pt1, pt2 = new_pt2;          };
    void const set_guard_spot(glm::vec3(new_guard_spot)) { guard_spot = new_guard_spot; };
